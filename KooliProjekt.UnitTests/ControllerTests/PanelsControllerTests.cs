...
namespace KooliProjekt.UnitTests.ControllerTests
{
    public class PanelsControllerTests
    {
        ...
        public async Task Index_should_return_view_and_data()
        {
            ...
            {
                new Panel { Id = 1, Title = "Test 1" },
                new Panel { Id = 2, Title = "Test 2" }
            };
            var pagedResult = new PagedResult<Panel>
            {
                Results = data,
                CurrentPage = 1,
                PageCount = 1,
        ...
        public async Task Details_should_return_correct_view_with_model_when_item_was_found()
        {
            // Arrange
            int? id = 1;
            var Panel = new Panel { Id = id.Value, Title = "Test 1" };
            _panelsServiceMock
                .Setup(x => x.Get(id.Value))
                .ReturnsAsync(Panel);
            ...
            Assert.Equal(Panel, result.Model);
        }
